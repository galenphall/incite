...
and detecting section headings via font size analysis. Text cleaning and paragraph
detection heuristics live in ``incite.corpus.pdf_paragraph``.

Related modules:
    - incite.corpus.pdf_paragraph: Low-level text cleaning and paragraph/heading heuristics.
    - incite.corpus.chunking: Higher-level chunking that consumes extracted paragraphs.
"""
...
from incite.corpus.pdf_paragraph import (
    _clean_text,
    _filter_front_matter_with_pages,
    _looks_like_heading,
