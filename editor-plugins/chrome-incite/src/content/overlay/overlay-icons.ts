...
/** Plus circle — add paper / quick save. */
export const ICON_ADD_PAPER = `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
/** Book — browse library. */
export const ICON_LIBRARY = `<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M2.5 3h4L8 4.5l1.5-1.5h4v9h-4.5L8 12.5 6.5 12H2.5V3z" stroke="currentColor" stroke-width="1.25" stroke-linejoin="round"/>
  <path d="M8 4.5V12.5" stroke="currentColor" stroke-width="1.25"/>
</svg>`;
